...
benchmarks! {
    ...
    report_works {
        ...
        let mut files: Vec<(Vec<u8>, u64)> = vec![
        ...
        for i in 0..10u32.pow(m) {
            files.push((vec![91,183,6,50,10,252,99,59,251,132,49,8,228,146,25,43,23,210,182,185,217,238,11,121,94,233,84,23,254,8,182,96],134289408));
        }
